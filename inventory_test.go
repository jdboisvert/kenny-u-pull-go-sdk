...
func Test_GetInventory_SingleInventoryItem(t *testing.T) {
	...
	assert.Equal(t, inventoryListings[0], InventoryListing{"2010", "LEXUS", "IS 250", "2023-01-06", "26A", "Ottawa", "https://kennyupull.com/part/lexus-is250-2010-93/"})
}
...
func Test_GetInventory_MultipleInventoryItems(t *testing.T) {
	...
	assert.Equal(t, inventoryListings[0], inventoryListing)
	assert.Equal(t, inventoryListings[1], inventoryListing)
}
